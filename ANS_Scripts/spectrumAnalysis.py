...
date = '0816'
noiseOnly,b = common.readAllAcqs('E:/JiaxingData/EMINoise/0827/NoiseSignal_32_256.h5')
noiseOnly = dp.ConvergeComplexR(dp.SplitComplexR(noiseOnly))
noiseImage,b = common.readAllAcqs('E:/JiaxingData/EMINoise/0827/NoisyImg.h5')
...
flip0,b = common.readAllAcqs('E:/JiaxingData/EMINoise/0827/0Flip.h5')
...
noisePre0,b = common.readAllAcqs('E:/JiaxingData/EMINoise/0827/0Flip.h5',table_name="noise")
...
sampling_frequency2 = common.getRate('E:/JiaxingData/EMINoise/0827/NoisyImg.h5')
sampling_frequency3 = common.getRate('E:/JiaxingData/EMINoise/0827/0Flip.h5')
...
plt.grid()
plt.legend(['noise only','noise map','flip Angle 0','regular noise preScan', '0FlipAngle noise preScan'])
